...
var TransportStore = assign({}, EventEmitter.prototype, {
  ...
  init: function(rawConnections) {
    ...
    var departureTimestamp = connection['from']['departureTimestamp'],
        ...
        firstJourneyName = connection['sections'][0]['journey']['name']
    
    if(firstJourneyName.indexOf("NFT 8")<0) return console.log("Nope: "+firstJourneyName);
    console.log("Yep: "+firstJourneyName);
